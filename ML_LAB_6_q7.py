...
weights_input_hidden, weights_hidden_output, bias_hidden, bias_output, error_list_and = backpropagation(X_and, y_and, learning_rate_and, epochs_and, convergence_error_and)

# Test the neural network
hidden_layer_input_and = np.dot(X_and, weights_input_hidden) + bias_hidden
hidden_layer_output_and = sigmoid(hidden_layer_input_and)

output_layer_input_and = np.dot(hidden_layer_output_and, weights_hidden_output) + bias_output
predicted_output_and = sigmoid(output_layer_input_and)

# Print the final predictions for AND gate logic
print("Final Predictions for AND Gate Logic:")
